...
var Indx=mySubject;
with (document.getElementById('id_shahr')) 
{
options.length=0;
if (Indx==0)
{
...
options[23]=new Option(" سپاهان شهر","24-سپاهان شهر");
}
if (Indx==5)
{
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
options[8]=new Option(" سرايان","9-سرايان");
options[9]=new Option(" طبس","10-طبس");
}
if (Indx==11)
{
options[0]=new Option("لطفا شهر خود را انتخاب کنيد","");
...
options[6]=new Option(" مهريز","1-مهريز");
options[7]=new Option(" ميبد","2-ميبد");
options[8]=new Option(" هرات","3-هرات");
options[9]=new Option(" يزد","4-يزد");
}
